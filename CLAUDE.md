...
**Node.js 24 compatibility:** All actions upgraded to Node.js 24-compatible versions as of v0.1.4 (2026-04-07). `jetli/wasm-pack-action` replaced with `cargo install wasm-pack` (unmaintained, no Node 24 support). `actions/upload-artifact` upgraded from v5 to v7 (2026-04-13). GitHub forces Node.js 24 runtime starting June 2, 2026; Node.js 20 removed from runners Sept 16, 2026.
